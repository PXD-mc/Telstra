...
<h4> This repository includes the code from the 'Telstra' Ranked Bedwars bot which was created by me 'Telstra' discord server. You are allowed to use the code as long as you do not violate the license. </h4>
